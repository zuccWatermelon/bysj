<!--优惠条件参考对象配置-->
<template>
  <div class="discountRef">
    <div class="add-discountRef"><a href="javascript:void(0);" @click="addFun">添加定价参考对象</a></div>
    <div class="title">
    ...
    <div class="discountRef-list clearfix" v-for="(item,index) in newdiscountRefList">
...
<script>
  export default{
    props:['currentStep','discountRefList'],
    data(){
      return{
        newdiscountRefList:[],
        status1:[
    ...
    methods:{
      addFun(){
        ...
        this.newdiscountRefList.push(data);
      },
      closeFun(){
      ...
      submitFun(){
        ...
        self.$emit('update:discountRefList', self.newdiscountRefList);
      },
      deleteFun(index){
        this.newdiscountRefList.splice(index,1);
      }
    }
  }
</script>
