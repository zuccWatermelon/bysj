<template>
  <div id="calendar">
    ...
    <ul class="days">
      ...
      <li  v-for="dayobject in days" @click="selectDate(dayobject.day)">
        <!--本月-->
        <!--如果不是本月  改变类名加灰色-->
        ...
        <!--如果是本月  还需要判断是不是这一天-->
          <!--今天  同年同月同日-->
          <span v-else :class="{active:dayobject.day.getFullYear() == new Date().getFullYear() && dayobject.day.getMonth() == new Date().getMonth() && dayobject.day.getDate() == new Date().getDate()}">{{ dayobject.day.getDate() }}</span>
